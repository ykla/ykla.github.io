import{_ as e,o as i,c as n,e as l}from"./app.6b09a359.js";const a={},s=l(`<h1 id="_15-3-ipfw" tabindex="-1"><a class="header-anchor" href="#_15-3-ipfw" aria-hidden="true">#</a> 15.3 IPFW</h1><h2 id="introduction-description" tabindex="-1"><a class="header-anchor" href="#introduction-description" aria-hidden="true">#</a> Introduction Description.</h2><p>IPFIREWALL (IPFW) is a firewall application initiated by FreeBSD and written and maintained by volunteer members of the FreeBSD community.</p><p>In FreeBSD 12, ipfw has been compiled into the kernel by default, and it will have a rule by default, rule number <code>65536</code>, which cannot be removed. This rule will cut off all traffic, so do not start ipfw at random before it has been configured, or you will face the problem of not being able to connect to remote FreeBSD.</p><blockquote><p>Graphical configuration tool:</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>#pkg install fwbuilder
