import{I as g,j as L,J as D,_ as F,f as C,O as B,o as u,c as p,K as A,$ as E,a as m,D as y,X as w,F as x,l as I,t as b,m as T,a0 as _}from"./app.bec921d0.js";const $={},P=[{path:"/",title:"FreeBSD MFGA",pathLocale:"/",contents:[{header:"FreeBSD MFGA",slug:"freebsd-mfga",content:""},{header:"FreeBSD-MFGA Copyright 2022",slug:"freebsd-mfga-copyright-2022",content:`Note
...
You also need to install this driver under > wayland. If the screen is not displayed properly (too big), please try: Edit the virtual machine settings --> Hardware, Devices --> Monitor --> Monitor, Specify monitor settings --> Maximum resolution for any monitor, set to the host's resolution or slightly lower than the host's resolution.`},{header:"Virtual Machine Enhancement Tools",slug:"virtual-machine-enhancement-tools",content:`If there is a desktop
