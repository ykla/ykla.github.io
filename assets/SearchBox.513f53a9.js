import{I as g,j as L,J as D,_ as F,f as C,O as B,o as u,c as p,K as A,$ as E,a as m,D as y,X as w,F as x,l as I,t as b,m as T,a0 as _}from"./app.d9f1e772.js";const $={},P=[{path:"/",title:"FreeBSD MFGA",pathLocale:"/",contents:[{header:"FreeBSD MFGA",slug:"freebsd-mfga",content:""},{header:"FreeBSD-MFGA Copyright 2022",slug:"freebsd-mfga-copyright-2022",content:`Note
...
If you don't have a network (internet) set DNS to 223.5.5.5. If not, see other sections in this chapter.`},{header:"Method \u2461 NAT",slug:"method-2-nat",content:`Network setup is complicated, and sometimes bridging does not always work. For the purpose of controlling the FreeBSD system in a virtual machine using a host (e.g. Windows 10), you need to set up two NICs - one in NAT network mode for Internet access and the other in host-only mode for interoperability with the host. As shown in the figure. Use the command # ifconfig to see if the second NIC em1 is not getting an ip address, please DHCP it manually: # dhclient em1 to get it (for long term effect add ifconfig_em1="DHCP" to /etc/rc.conf).
If you don't have a network (internet) set DNS to 223.5.5.5. If not, see other sections in this chapter.`},{header:"Install enhancement tools",slug:"install-enhancement-tools",content:`## pkg install virtualbox-ose-additions
...
If there is no network, please set the DNS to 223.5.5.5. Please see section 4 of this chapter.`},{header:"Graphics drivers and virtual machine enhancement tools",slug:"graphics-drivers-and-virtual-machine-enhancement-tools",content:""},{header:"Graphics drivers",slug:"graphics-drivers",content:`For VMware to automatically scale the screen please install the graphics card driver and the virtual machine enhancement tool, i.e.
