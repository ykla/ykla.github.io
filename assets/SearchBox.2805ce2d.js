import{I as g,j as L,J as D,_ as F,f as C,O as B,o as u,c as p,K as A,$ as E,a as m,D as y,X as w,F as x,l as I,t as b,m as T,a0 as _}from"./app.eb802b87.js";const $={},P=[{path:"/",title:"FreeBSD MFGA",pathLocale:"/",contents:[{header:"FreeBSD MFGA",slug:"freebsd-mfga",content:""},{header:"FreeBSD-MFGA Copyright 2022",slug:"freebsd-mfga-copyright-2022",content:`Note
...
We chose FreeBSD because we wanted a clear, unambiguous, reliable, and solid operating system that would bring us profit in our work and pleasure in our lives. Of course there are still many problems with FreeBSD that need to be actively discovered, explored, and improved. Society is progressing, technology is advancing, enthusiasm is continuing unabated, and the future is getting better and better.`},{header:"Blacklisting",slug:"blacklisting",content:`We encountered many difficulties in building the FreeBSD Chinese community: some Arch linux cultists provoked us by saying "Arch is awesome! There were also some people who had never used BSD before, saying that there was no JAVA, no JNI, and no Eclipse in FreeBSD; there were also some Huawei fans who entered the community and tried to start an infighting by using Android's Hongmeng system as a shell. For the community, we have established a blacklist system.
The list is as follows.`},{header:"2018-2021",slug:"_2018-2021",content:`QQ number
reason for blacklisting 3623404390
Kick down the ladder, get the answer to the question and withdraw from the group, the same below 554412630
The administrator gave every student facing the college entrance exam a college entrance exam gift package (permission to the end of the exam) on the eve of the exam in order to prepare for the exam at ease, but he withdrew from the group to avoid permission 1354998
Insult BSD and promote Linux 156798543
Provoking trouble 1113749776
Huawei fan 2151722905
Enter the group babbling and pretending to be new, pretending to be stupid, name is database, suspected of being an artificial intelligence, good at asking some messy patchwork of non-existent questions: such as \`\`assembly language between c languages, there is a language. It was ignored. The whole IT world lost a model for another development. Another example is that one of the rows of the database table can be seen as an argument to a function. This function name, why does not appear in this record line? Is the function name omitted? Does it take this table as a parameter? Does it use the data stream of this table as a parameter? In a broader view, programming languages can construct algebra and geometry. I just haven't thought it through yet. and framework, what is it? Are they devices? Looking at vue pairs, is it a device? Why, if you go to a computer store, you can buy cpu, memory sticks, and disks. But you can't buy a column? and assuming println() is a service function that starts with main and doesn't close. The argument stream can be written to at any time. Traditional interpretations of functions may be wrong. Practicality Feasibility masks crudeness absurdity. In all likelihood, it is only right for functions to disable names and functions to disable comments. (However, the pragmatic view does not allow this nowadays). The reality of function namelessness and function de-annotation is unacceptable. \` For more, please submit an issue 504658598
Cursing 3458921559
Insulting BSD and promoting ArchLinux, thinking that BSD has no JAVA, no JNI, no Eclipse, etc. In short, his point is that FreeBSD has nothing and is a piece of crap. The first time I saw it, I was hit in the face and started to provoke the administrator, nicknamed Rainbow Pirates, now called "Damien Sauce", the elitist, whose github address is https://github.com/mingmoe 2018456
Insulting BSD, provoking administrators 383925617
huawei fan, Insulting the administrator 1510908166
Kick down the ladder 1771336464
provoking 595063679
Crank and Minzhe. The first thing you need to do is to get a good idea of what you are getting into. 273459714
Crank and Minzhe. Put forward historiography that is inconsistent with common sense, dare to imagine Owen science without knowing the philosophy of text translation, and there is no theory of a century, and there is no theory of modern philosophy. 571060051
Repeatedly and strangely destroy the atmosphere, whenever someone provokes the administrator will come out to perform, adding fuel to the fire 3303672033
Open source cult, good at the philosophy of suffering, self-righteous, half a bottle of water wandering, think LaTeX in writing novels better than Word, think libreoffice should not be compatible with Word, should be the other way around by Word to compatible with him, the classic quote "What makes you say that Libreoffice compatibility is not good? " Why don't you use GIMP, why do you use PS, why do you use Windows 10. The reason for the blacklisting is that the user's name is not the name of the administrator. WeChat name
reason for blacklisting \u5F69\u8679\u6D77\u76D7
Insulting BSD and promoting ArchLinux. Others as above Baidu TieBa ID
Reasons for Blacklisting mechrtt
The tutorials of other people pretending to be tutorials written by themselves, shamelessly. The first thing you need to do is to get a good idea of what you're doing.`},{header:"2022",slug:"_2022",content:`QQ number
reason for blacklisting 1187908617 2777184456
Ignoring the results of FreeBSD's promotion and treating it as advertising 1301771
Intentionally violated Group Rule 8 and absconded 369866382
Once said he loved FreeBSD so much that he wanted to get involved in the community, and after asking my opinion, he was given the task of translating the Handbook. After a long time, he said he didn't have time to do it and didn't say why, then he looked at the progress and only translated a small chapter or how many, in any case, it was not finished, asked him if he could finish the small chapter, he firmly said "no", and after paying for its translation reward of a chapter, he stopped talking in the WeChat group. Then one day in the QQ group, he said that running tutorials should not add any root tutorials to sddm, which looks very low-end, and then said he never used it, meaning he wouldn't let others use it either. It's like those who don't use QQ and don't let others use it, but he still honestly used WeChat, and I said it was called "work needs". After that, he was in the group looking for trouble, saying that translating the documentation was pointless, that only idiots would participate, and that FreeBSD was a piece of crap. After being removed from the group, I saw that it was the same person from the WeChat group, Jim Googe, who has now blended in with the rest of the FreeBSD community. The bottom line of not opposing our work is to continue to be in the group 9516665
Playing dumb, suspicious 1301771, hint: QQ digits less than 8 digits are mostly problematic 428819551
Rejecting questionnaires, reaching out to the party, insulting the community 197405656
See 2022 CFC 1 announcement 3142739069
Refused to comply with CFC charter WeChat Name
Reason for Blacklisting \u5360\u6208\u54E5\u6B20
Alias account of 369866382 We hope that the major open source communities will take note of this and beware of malicious damage by the above people. Blacklisted users cannot be unblocked.`}]},{path:"/SUMMARY.html",title:"Table of contents",pathLocale:"/",contents:[{header:"Table of contents",slug:"table-of-contents",content:"FreeBSD MGFA"},{header:"Chapter 0 FreeBSD MFGA",slug:"chapter-0-freebsd-mfga",content:"0.1. Deficiencies of FreeBSD"},{header:"Chapter 1. Approaching FreeBSD",slug:"chapter-1-approaching-freebsd",content:`1.1 What is UNIX
...
optional
powershell
Windows desktop MacOS
1 year/about 5 years
none
proprietary
clang
zsh
Aqua`},{header:"What is FreeBSD?",slug:"what-is-freebsd",content:`BSD was originally developed by the University of California, Berkeley, and stands for Berkeley Software Distribution.
...
Set it? [Yes]. Note: Logitech M337 will automatically disconnect after pairing connection. Solution: Delete the bd_addr line xx:xx:xx:xx in the /var/db/bthidd.hids file corresponding to the mouse and restart the bthidd service # service bthidd restart.`}]},{path:"/chapter-2.-installing-freebsd/2.2-freebsd-13.0-installation-based-on-virtual-box.html",title:"2.2 FreeBSD 13.0 Installation - Based on Virtual Box",pathLocale:"/",contents:[{header:"2.2 FreeBSD 13.0 Installation - Based on Virtual Box",slug:"_2-2-freebsd-13-0-installation-based-on-virtual-box",content:""},{header:"Downloading VirtualBox",slug:"downloading-virtualbox",content:`Click download to download.
https://www.virtualbox.org`},{header:"Installation Setup",slug:"installation-setup",content:"After the installation is complete, please manually shut down your computer and uninstall or remove the installation CD, otherwise you will still be at the installation screen."},{header:"Network settings",slug:"network-settings",content:""},{header:"Method \u2460 Bridging",slug:"method-1-bridging",content:`Bridging is the simplest way to interoperate between the host and the virtual machine, and can obtain an IP address in the same IP segment as the host, such as the host is 192.168.31.123, the address of the virtual machine is 192.168.31.x. ! After setting # dhclient em0 you can (for long term effect add ifconfig_em0="DHCP" in /etc/rc.conf).
If you don't have a network (internet) set DNS to 8.8.8.8. If not, see other sections in this chapter.`},{header:"Method \u2461 NAT",slug:"method-2-nat",content:`Network setup is complicated, and sometimes bridging does not always work. For the purpose of controlling the FreeBSD system in a virtual machine using a host (e.g. Windows 10), you need to set up two NICs - one in NAT network mode for Internet access and the other in host-only mode for interoperability with the host. As shown in the figure. Use the command # ifconfig to see if the second NIC em1 is not getting an ip address, please DHCP it manually: # dhclient em1 to get it (for long term effect add ifconfig_em1="DHCP" to /etc/rc.conf).
If you don't have a network (internet) set DNS to 8.8.8.8. If not, see other sections in this chapter.`},{header:"Install enhancement tools",slug:"install-enhancement-tools",content:`## pkg install virtualbox-ose-additions
...
If there is no network, please set the DNS to 8.8.8.8. If not, see other sections in this chapter.`},{header:"Graphics drivers and virtual machine enhancement tools",slug:"graphics-drivers-and-virtual-machine-enhancement-tools",content:""},{header:"Graphics drivers",slug:"graphics-drivers",content:`For VMware to automatically scale the screen please install the graphics card driver and the virtual machine enhancement tool, i.e.
## pkg install xf86-video-vmware open-vm-tools
After installation, you don't need any extra configuration to achieve automatic screen scaling. Do not make redundant configurations, such as creating xorg.conf, as this can cause problems such as virtual machine crashes. You also need to install this driver under wayland. Even though wayland is temporarily unavailable. If the screen is not displayed properly (too big), please try: Edit the virtual machine settings --> Hardware, Devices --> Monitor --> Monitor, Specify monitor settings --> Maximum resolution for any monitor, set to the host's resolution or slightly lower than the host's resolution.`},{header:"Virtual Machine Enhancement Tools",slug:"virtual-machine-enhancement-tools",content:`If there is a desktop
...
# pkg create nginx`},{header:"FreeBSD package upgrade management tool",slug:"freebsd-package-upgrade-management-tool",content:`First update the ports
## portsnap auto
...
xorg minimal package: xorg-minimal (not recommended)`},{header:"Installing",slug:"installing",content:`Install via pkg:
# pkg install xorg
Install via ports:
...
# echo $0
If it's either csh/tcsh, continue.`},{header:"Install",slug:"install",content:"# pkg install xorg sddm kde5 wqy-fonts xdg-user-dirs The above command installs the desktop, window manager and Chinese fonts and the tools to create user directories, respectively."},{header:"Configuration",slug:"configuration",content:`# ee /etc/fstab
Add the following:
proc /proc procfs rw 0 0 Add proc mount this step is very necessary, if not add will cause the desktop service can not run properly, some components can not be loaded! Note
If you don't configure proc, all your icons will become unclickable white squares under normal users. And subsequent configuration is also invalid, you must reinstall the system. Then
# sysrc dbus_enable="YES"
# sysrc sddm_enable="YES"
and then
# echo "exec ck-launch-session startplasma-x11" > ~/.xinitrc If you have already run it under root, a new user will still have to run it again to use it properly (no root privileges or sudo, etc.) startx. Hint: hal has been removed. No need to add hald_enable="YES", See.
https://www.freshports.org/sysutils/hal normal users also need to add the user to the wheel group.
...
If you are using a VMware virtual machine and can't see the options at the bottom of sddm, please follow the tutorial in the Configuring Virtual Machines section to configure screen auto-scaling.`},{header:"i18n",slug:"i18n",content:'Click Start -> System Settings -> Regional Settings and find "Simplified Chinese" in the Available Language column of the Language item and click > to add it to the Preferrred Languages column, then click the Apply button; then go to the Formats item, change the content in the Region text box to "China - Simplified Chinese (zh-CN)", click the Apply button, logout and log in again, then the The system language will change to Chinese.'}]},{path:"/chapter-4.-desktop-installation/4.3-installing-gnome.html",title:"4.3 Installing Gnome",pathLocale:"/",contents:[{header:"4.3 Installing Gnome",slug:"_4-3-installing-gnome",content:""},{header:"Installing",slug:"installing",content:`# pkg install xorg gnome wqy-fonts xdg-user-dirs
