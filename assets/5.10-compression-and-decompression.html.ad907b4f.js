import{_ as e,o as i,c as a,e as s}from"./app.4972cae2.js";const t={},n=s(`<h1 id="_5-10-compression-and-decompression" tabindex="-1"><a class="header-anchor" href="#_5-10-compression-and-decompression" aria-hidden="true">#</a> 5.10 Compression and decompression</h1><h2 id="zip" tabindex="-1"><a class="header-anchor" href="#zip" aria-hidden="true">#</a> zip</h2><p>Installing zip zip files <code># pkg install zip unzip</code></p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code># zip test.zip test # Pack a zip format file 
