import{I as g,j as L,J as D,_ as F,f as C,O as B,o as u,c as p,K as A,$ as E,a as m,D as y,X as w,F as x,l as I,t as b,m as T,a0 as _}from"./app.4897455b.js";const $={},P=[{path:"/",title:"FreeBSD MFGA",pathLocale:"/",contents:[{header:"FreeBSD MFGA",slug:"freebsd-mfga",content:""},{header:"FreeBSD-MFGA Copyright 2022",slug:"freebsd-mfga-copyright-2022",content:`Note
...
# chmod -R 0700 /samba/testshare`}]},{path:"/chapter-16.-servers/16.8-nfs-server.html",title:"16.8 NFS server",pathLocale:"/",contents:[{header:"16.8 NFS server",slug:"_16-8-nfs-server",content:""}]},{path:"/chapter-16.-servers/16.9-iscsi.html",title:"16.9 iSCSI",pathLocale:"/",contents:[{header:"16.9 iSCSI",slug:"_16-9-iscsi",content:""}]},{path:"/chapter-17.-web-server/17.1-apache.html",title:"",pathLocale:"/",contents:[{header:"17.1 Apache",slug:"_17-1-apache",content:""},{header:"Installing",slug:"installing",content:`# cd /usr/ports/www/apache24/ && make install clean
or
...
After saving, run go run helloWorld.go in the terminal to output the code.`}]},{path:"/chapter-22.-programming-and-development/22.9-csh-and-other-shells.html",title:"",pathLocale:"/",contents:[{header:"Section 9 Csh and Other Shells",slug:"section-9-csh-and-other-shells",content:""},{header:"FreeBSD csh shell configuration",slug:"freebsd-csh-shell-configuration",content:`Note
...
The DragonFly BSD documentation is old and does not match its development progress, but DragonFly BSD development is actually quite active. Don't be dissuaded by DragonFly BSD's outdated official documentation.`}]},{path:"/chapter-28.-dragonflybsd/28.1-installation-and-configuration.html",title:"",pathLocale:"/",contents:[{header:"28.1 Installation and Configuration",slug:"_28-1-installation-and-configuration",content:""},{header:"Change source",slug:"change-source",content:`# ee /usr/local/etc/pkg/repos/df-latest.conf
...
# cd /usr/ports/editors/linux-wps-office/ && make install clean # add BATCH=yes if you want to default`}]},{path:"/chapter-5.-input-method-and-common-software/5.7-installing-qq.html",title:"5.7 Installing QQ",pathLocale:"/",contents:[{header:"5.7 Installing QQ",slug:"_5-7-installing-qq",content:`Introduction
