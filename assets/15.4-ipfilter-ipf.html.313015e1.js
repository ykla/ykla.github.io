import{_ as e,o as i,c as t,e as s}from"./app.fa6ef32d.js";const n={},a=s(`<h1 id="_15-4-ipfilter-ipf" tabindex="-1"><a class="header-anchor" href="#_15-4-ipfilter-ipf" aria-hidden="true">#</a> 15.4 IPFILTER (IPF)</h1><p>IPF is an open source software by Darren Reed.</p><p>If you want to enable ipf, you can execute the following command.</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code># ipfilter 
