import{_ as e,o as n,c as i,e as a}from"./app.9e92ab39.js";const s={},d=a(`<h1 id="_16-7-samba-server" tabindex="-1"><a class="header-anchor" href="#_16-7-samba-server" aria-hidden="true">#</a> 16.7 samba server</h1><h2 id="set-up-samba-as-a-standalone-server" tabindex="-1"><a class="header-anchor" href="#set-up-samba-as-a-standalone-server" aria-hidden="true">#</a> Set up samba as a standalone server</h2><p>Environment: freebsd 11</p><h3 id="install-samba" tabindex="-1"><a class="header-anchor" href="#install-samba" aria-hidden="true">#</a> Install samba</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code># pkg install samba413
